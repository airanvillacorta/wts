    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class=""></i> Inmuebles de Ejemplo</div>
        <div class="card-body">

          Seleccione una organización para listar sus inmuebles:


          <form name="myForm" action="" onsubmit="return " enctype="multipart/form-data" method="post">
          <?php
          ...
          ?>
          <button type="submit" name="submit" class="btn btn-primary">Listar</button>
          </form>
