...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT IMN_id,IMN_Titulo, IMN_referencia,IMN_precio,IMN_habitaciones,IMN_habitaciones,IMN_banos,IMN_m2,IMN_venta, IMG_path FROM inmueble, imagen WHERE IMN_id=IMG_id_INM AND IMN_organizacion ='$id' AND CONCAT(`IMN_referencia`, `IMN_Titulo`, `IMN_tipo`) LIKE '%".$valueToSearch."%' GROUP BY IMN_id";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT IMN_id,IMN_Titulo, IMN_referencia,IMN_precio,IMN_habitaciones,IMN_habitaciones,IMN_banos,IMN_m2,IMN_venta, IMG_path FROM inmueble, imagen WHERE IMN_id=IMG_id_INM AND IMN_organizacion ='$id' GROUP BY IMN_id";
