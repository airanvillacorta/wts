  ...
  <body>
    ...
    <div class="container">
      ...
      <header class="masthead">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<a class="navbar-brand" href="index.php?id=5"><b>S.G.I. GECKO</b></a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						<a class="nav-link" href="index.php?id=5>">Inicio <span class="sr-only">(current)</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="empresa.php?id=5">La empresa</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="servicios.php?id=5">Servicios</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="contacto.php?id=5">Contacto</a>
					</li>
				</ul>
				<div class="form-inline my-2 my-lg-0">
					<a href="inmuebles.php?id=5">
    ...
    border: 1px solid #e5e5e5;">
      ...
      <footer class="footer">
      	<div class="row">
          <div class="col-lg-3">
          	<p>&copy; 2017 - S.G.I. GECKO.</p>
          </div>
          <div class="col-lg-9">
			  <p class="text-right">Sigue a Empresa.SL en las redes sociales:
